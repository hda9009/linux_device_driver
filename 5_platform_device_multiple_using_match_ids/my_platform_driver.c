...
struct device_config_data device_data[MAX_DEVICES];
struct platform_device_id my_platform_device_ids[MAX_DEVICES];

struct device_config_data device_data[MAX_DEVICES] = {
    [DEVICE_ID_1] = {.data = 100, .buffer = "Config Data 1"},
    [DEVICE_ID_2] = {.data = 200, .buffer = "Config Data 2"},
    [DEVICE_ID_3] = {.data = 300, .buffer = "Config Data 3"},
};

struct device_config_data my_device_config_data[MAX_DEVICES] = {
    [DEVICE_ID_1] = {.data = 100, .buffer = "config_data_1"},
    [DEVICE_ID_2] = {.data = 200, .buffer = "config_data_2"},
    [DEVICE_ID_3] = {.data = 300, .buffer = "config_data_3"},
};
...
int my_platform_driver_probe(struct platform_device *probed_platform_device)
{
    ...
    device_private_data->device_number = driver_private_data.device_num_base + probed_platform_device->id; // devt is the device number
